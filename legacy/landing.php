...
$recentJobs = $jobManager->getAllJobs('active');

// Limit to 3 most recent jobs
$recentJobs = is_array($recentJobs) ? array_slice($recentJobs, 0, 3) : [];
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>PT. PUTRI KEBUN LESTARI - Bergabunglah dengan Tim Kami</title>
...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="text-center">
                <h1 class="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
                    Bergabunglah dengan <span class="text-blue-600">Tim Kami</span>
                </h1>
                <p class="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                    PT. PUTRI KEBUN LESTARI mencari talenta terbaik untuk bergabung dengan tim food and beverage terdepan kami
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="jobs.php" class="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition duration-200 text-lg font-medium">
                        <i class="fas fa-search mr-2"></i>Lihat Lowongan Kerja
                    </a>
                    <a href="auth/register.php" class="bg-white text-blue-600 px-8 py-3 rounded-lg hover:bg-gray-50 transition duration-200 text-lg font-medium border border-blue-600">
    ...
    <div class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">About farm.girl</h2>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="prose prose-lg mx-auto text-gray-700">
                    <p class="mb-6">
                        farm.girl was founded in 2019 by Tiffanie Widjaja, a chef, mother, and hospitality professional. Trained at the Institute of Culinary Education (ICE) in New York City, Tiffanie honed her skills at some of the city's most acclaimed Michelin-starred kitchens, including Jean-Georges, Daniel, and Annisa.
                    </p>
                    
                    <p class="mb-6">
                        While completing her Master's in Hospitality Management at Cornell University, she began recreating the comforting flavors from her life in the U.S.—a blend of soulful recipes and elevated technique. What started as a summer project—selling cinnamon rolls and sandwiches online—quickly gained momentum.
                    </p>
                    
                    <p class="mb-6">
                        Within months, farm.girl opened its first brick-and-mortar café in Menteng, Jakarta, designed to feel like a home away from home. A cozy space filled with familiar tastes, warm smiles, and food that brings back memories. Two months later, she launched the farm.girl Bakehouse in Jakarta Selatan, producing daily baked goods for its sister outlets and supplying white-label items for distribution.
                    </p>
                    
                    <h3 class="text-2xl font-bold text-gray-900 mb-4 mt-8">Where We Are Now</h3>
                    
                    <p class="mb-6">
                        Today, farm.girl operates multiple locations across Jakarta and proudly serves as the official food & beverage partner at the U.S. Embassy, the Australian Embassy, and the Pavilion at the American Club—a reflection of our commitment to excellence, consistency, and food safety.
                    </p>
                    
                    <p class="mb-6">
                        Our original Menteng café has since evolved into farm.girl Table, an elevated dining experience with a wider menu featuring steaks, pastas, handcrafted cocktails, and a curated wine list, while preserving the heartwarming comfort that defines the brand.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <?php else: ?>
                    ...
                    if ($index % 3 == 0) {
                        // Left column (1st, 4th, 7th, etc.)
                        $animationClass = 'animate__zoomInLeft';
                    } elseif ($index % 3 == 1) {
                        // Middle column (2nd, 5th, 8th, etc.)
                        $animationClass = 'animate__zoomInUp';
                    } else {
                        // Right column (3rd, 6th, 9th, etc.)
                    ...
                    ?>
                    <div class="job-card bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 group overflow-hidden relative" data-animation="<?php echo $animationClass; ?>" data-delay="<?php echo $delayClass; ?>">
                        ...
                        <div class="relative p-6">
                            <div class="flex justify-between items-start mb-4">
                                <div class="transform group-hover:translate-x-1 transition-transform duration-300">
                                    <h3 class="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors duration-300"><?php echo htmlspecialchars($job['position']); ?></h3>
                            ...
                            <div class="space-y-3 mb-4">
                                ...
                                <div class="flex items-center text-sm text-gray-600 transform group-hover:translate-x-2 transition-transform duration-300 delay-100">
                                    ...
                                    <span class="group-hover:text-gray-800 transition-colors duration-300"><?php echo htmlspecialchars($job['employment_type']); ?></span>
                                </div>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <a href="jobs.php" class="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-2 rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-300 text-sm font-medium transform hover:scale-105 hover:shadow-lg group/btn">
                                    <i class="fas fa-eye mr-1 group-hover/btn:animate-pulse"></i>Lihat Detail
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="bg-blue-600">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <!-- CTA Button -->
            <div class="text-center">
                <a href="auth/register.php" class="bg-white text-blue-600 px-8 py-3 rounded-lg hover:bg-gray-100 transition duration-200 text-lg font-medium">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400">PT. PUTRI KEBUN LESTARI adalah perusahaan food and beverage terdepan yang berfokus pada makanan cepat saji. Kami mencari talenta terbaik untuk bergabung dengan tim kami yang dinamis dan berdedikasi.</p>
                </div>
                
                <div>
                    <h4 class="text-lg font-semibold mb-4">Untuk Pelamar</h4>
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="auth/register.php" class="hover:text-white">Daftar Akun</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="auth/login.php" class="hover:text-white">Login HRD</a></li>
                        <li><a href="auth/login.php" class="hover:text-white">Login Admin</a></li>
                    </ul>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function animateJobCards() {
                jobCards.forEach((card, index) => {
                    if (isInViewport(card)) {
                        // Only trigger animation if not already animated
                        if (!card.classList.contains('animate__animated')) {
                            console.log('Triggering animation for card', index); // Debug log
                ...
                entries.forEach((entry, index) => {
                    if (entry.isIntersecting) {
                        ...
                        if (!entry.target.classList.contains('animate__animated')) {
                            console.log('Intersection Observer triggered for card', index); // Debug log
                            ...
                            console.log('Applied animation:', animationType, 'with delay:', delay);
                        }
                    }
                });
            }, observerOptions);
