...
<head>
    ...
    <title>Manajemen Interview - HRD</title>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                ...
                                                <a href="video_interview.php?id=<?php echo $interview['id']; ?>" class="text-blue-600 hover:text-blue-900" title="Video Interview">
                                                    <i class="fas fa-video"></i>
                                                </a>
                                                <?php endif; ?>
                                                <a href="interview_feedback.php?id=<?php echo $interview['id']; ?>" class="text-green-600 hover:text-green-900" title="Interview Feedback">
                                                ...
                                                <button onclick="editInterview(<?php echo $interview['id']; ?>)" class="text-yellow-600 hover:text-yellow-900" title="Edit Interview">
        ...
        function cancelInterview(id) {
            if (confirm('Apakah Anda yakin ingin membatalkan interview ini?')) {
                ...
                form.innerHTML = `
                    ...
                    <input type="hidden" name="reason" value="Dibatalkan oleh HRD">
                `;
