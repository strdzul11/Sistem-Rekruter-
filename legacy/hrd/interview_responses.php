...
<head>
    ...
    <title>Interview Responses - HRD</title>
                ...
                <form method="POST" action="">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="question_id" required class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                        ...
                        <div>
                            ...
                            <select name="score" required class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="response_text" required rows="4" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Enter the candidate's response..."></textarea>
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Notes</label>
                            <textarea name="notes" rows="2" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500" placeholder="Additional notes..."></textarea>
                        </div>
                    </div>
                    <div class="mt-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-lg font-semibold text-green-600"><?php echo number_format($stat['average_score'], 1); ?></p>
                            </div>
                        </div>
