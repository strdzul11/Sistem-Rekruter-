...
// Cek apakah user sudah login dan role admin atau HRD
...
<body class="bg-gray-50">
    <div class="flex h-screen">
        <?php require_once 'includes/sidebar.php'; renderAdminSidebar('applications'); ?>
                    ...
                    <div class="mb-8">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-4">
                                <a href="evaluations.php" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition duration-200">
